...
def main():
    # 1. Configurazione
    csv_file_dataset = "data/Happy_Sad/dataset_prompt_Happy_Sad.csv"
    ...
    output_vec = f"{output_path}/steering_vector_Sad2Happy_layer{layer_target_idx}.pt"
